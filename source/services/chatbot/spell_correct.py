...
## Nhiệm vụ 1:
   - Nếu đầu vào của người dùng là một văn bản nhập linh tinh (nội dung không có ngữ nghĩa gì), hãy trả về ROUTING là UNCORRECT.
   - Các trường hợp còn lại hãy trả về ROUTING là CORRECT.

Lưu ý: đầu vào của người dùng có thể rất ngắn gọn, ví dụ như chỉ bao gồm: số điện thoại, ngày sinh, địa chỉ, ... những trường hợp thế này hãy trả về ROUTING là CORRECT
